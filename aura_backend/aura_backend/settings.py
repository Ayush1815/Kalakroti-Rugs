...
# Database – Dynamic switching between local SQLite and production PostgreSQL (Supabase)
import sys
...
# Caching – Redis Backend with Local Memory fallback for local development
...
if REDIS_URL:
    ...
    CACHES = {
        'default': {
            ...
            'LOCATION': 'kalakroti-local-cache',
        }
    }
